    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        <li class="dropdown-header">
          <h6 id="head_user_name">Kevin Anderson</h6>
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="#" onclick="logout()">
            ...
            <span id="logout-button">Sign Out</span>
          </a>
        </li>
...
<hr class="sidebar-divider">
  ...
  <li class="nav-heading" id="nav_heading">Account Fundamentals</li>
...
<hr class="sidebar-divider">
  ...
  <li class="nav-heading"><i class="bi bi-menu-button-wide mx-2"></i>Student Affairs Management</li>
  ...
  <a class="nav-link collapsed" data-bs-target="#access-nav" data-bs-toggle="collapse" href="#">
    ...
    <ul id="system-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="approval.php">
          <i class="bi bi-circle icon"></i><span>Permit Management</span>
        </a>
      </li>
    </ul>
  </li>
